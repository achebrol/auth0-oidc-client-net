...
{
    /// <summary>
    /// Interface for performing authentication and authorization operations with Ping using the
    ...
    public interface IPingClient
    {
        ...
        /// <summary>
        /// Launches a browser to log the user out and clear the Ping SSO Cookie.
        /// </summary>
        /// <param name="extraParameters">Optional extra parameters that need to be passed to the endpoint.</param>
        /// <param name="cancellationToken">Optional <see cref="CancellationToken"/> that can be used to cancel the request.</param>
        /// <returns>A <see cref="BrowserResultType"/> indicating whether the logout was successful.</returns>
        Task<BrowserResultType> LogoutAsync(object extraParameters = null, CancellationToken cancellationToken = default);
        ...
        /// <summary>
        /// Process the response from the Ping redirect URI.
        /// </summary>
