...
namespace Ping.OidcClient
{
    ...
    {
        /// <summary>
        /// Create a new instance of <see cref="PingClient"/> with a given <see cref="PingClientOptions"/>.
        /// </summary>
        /// <param name="options">The <see cref="PingClientOptions"/> specifying the configuration to use.</param>
        ...
        /// Alternatively set <see cref="PingClientOptions"/> RedirectUri and PostLogoutRedirectUri to match your <see cref="IntentFilterAttribute"/>. 
            ...
            : base(options, "xamarin-android")
        {
            ...
            var defaultRedirectUri = options.RedirectUri == null || options.PostLogoutRedirectUri == null
                ? GetConventionCallbackUri(options.Authority) : null;
        ...
        /// <summary>
        /// Create a new instance of <see cref="PingClient"/> with a given <see cref="PingClientOptions"/> and <see cref="Context"/>.
        /// </summary>
        /// <param name="options">The <see cref="PingClientOptions"/> specifying the configuration to use.</param>
        /// <param name="activity">The <see cref="Activity"/> with the <see cref="IntentFilterAttribute"/> you perform calls to <see cref="PingClient"/> from.</param>
        ...
        /// </remarks>
        public PingClient(PingClientOptions options, Activity activity)
            : base(options, "xamarin-android")
        {
            options.Browser = options.Browser ?? new AutoSelectBrowser(activity);
            options.RedirectUri = options.RedirectUri;
            options.PostLogoutRedirectUri = options.PostLogoutRedirectUri ?? options.RedirectUri;
        }
